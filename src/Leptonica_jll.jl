...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Leptonica_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6a1430e4-294a-53a5-a485-ec66ef6b843c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Leptonica", artifacts_toml) for e in artifacts["Leptonica"]]
...
if best_platform === nothing
    @debug("Unable to load Leptonica; unsupported platform $(triplet(platform_key_abi()))")
else
