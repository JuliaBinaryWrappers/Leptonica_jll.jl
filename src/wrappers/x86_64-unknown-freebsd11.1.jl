# Autogenerated wrapper script for Leptonica_jll for x86_64-unknown-freebsd11.1
export xtractprotos, convertfilestops, imagetops, convertsegfilestops, converttopdf, convertsegfilestopdf, fileinfo, liblept, converttops, convertformat, convertfilestopdf
...
const liblept_splitpath = ["lib", "liblept.so"]
